<?php include "includes/admin_header.php" /// header sent from header.php in admin includes folder ?>
    ...
    <?php /*
     ...
     testing connection to admin header.php
     */
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <small><?php  echo $_SESSION['username']; //using session from login through the header ?></small>
                        </h1>
    ...
    $subscriber_count = mysqli_num_rows($select_all_subscribers);
        ...
        ?>
                ...
                <div class="row">
                 ...
                 ?>
                          //  ['Posts', 1000], example data from google table 
...
<?php include "includes/admin_footer.php" /// header sent from footer.php in admin includes folder?>