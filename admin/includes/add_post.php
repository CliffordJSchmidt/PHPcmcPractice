...
// $query below is before makign $post comment count dynamic 
//$query .= "VALUES( '{$post_category_id}', '{$post_title}', '{$post_author}', now(), '{$post_image}', '{$post_content}', '{$post_tags}', '{$post_comment_count}', '{$post_status}' ) ";

        $create_post_query = mysqli_query($connection, $query);   // insert data
    ...
    //var_dump($create_post_query);
      ...
      echo "<p class='bg-success'>Post Created. <a href='../post.php?p_id={$the_post_id}'>View Post</a> or <a href='./posts.php'>Create More Posts</a></p>";
