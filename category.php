...
//needs to be debugged... trying to display a message 'sorry no posts in that category'
             //   if($post_category_id == null){
               //         echo "<h1 class='text-center'> Sorry, there are no posts in that category. </h1>";
               //         break 1;
               //     } else {
